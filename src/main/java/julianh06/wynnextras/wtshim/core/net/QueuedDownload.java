...
/* WynnExtras — a download registered by a component, with its completion handler (faithful port). */
...
public class QueuedDownload {
    ...
    // Exactly one of these is set; provided to the Download when it is processed
