...
/*
 * WynnExtras — TerritoryInfo (faithful port of Wynntils' advancement-lore parser).
 *
 * Shadowed fields: WynnExtras' TerritoryInfoMixin declares @Shadow for
 *   guildPrefix (String), defences (GuildResourceValues), headquarters (boolean, @Final),
 *   generators (HashMap<GuildResource, Integer>), storage (HashMap<GuildResource, CappedValue>).
 * These MUST stay as private instance fields with these exact names and types.
 */
