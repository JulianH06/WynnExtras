...
/*
 * WynnExtras — DateFormatter (verbatim port).
 * Formats a millisecond duration into a short/long human string ("3d 4h", "22m 10s").
 * Used by TerritoryProfile#getReadableRelativeTimeAcquired.
 */
