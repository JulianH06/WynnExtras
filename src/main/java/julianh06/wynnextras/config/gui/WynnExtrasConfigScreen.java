...
public class WynnExtrasConfigScreen extends Screen {
    ...
    private void renderDropdownOverlay(DrawContext ctx, int mouseX, int mouseY) {
        ...
        // FIRST: Draw a large solid opaque background to completely cover anything behind
        // This ensures nothing bleeds through
        ctx.fill(ddX - 5, ddY - 5, ddX + ddW + 5, ddY + visibleH + 5, BG_DARK);
