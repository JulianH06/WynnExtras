    ...
    private static class LootPoolWidget extends Widget {
        ...
        protected void drawContent(DrawContext ctx, int mouseX, int mouseY, float tickDelta) {
            ...
            if (items.isEmpty()) {
                ...
                ui.drawLine(x + 20, textY - 15, x + width - 20, textY - 15, 3, WynnExtrasConfig.INSTANCE.pvDarkmodeToggle ? CustomColor.fromHexString("1b1b1c") : CustomColor.fromHexString("5d4736"));
        ...
        private float drawItem(DrawContext context, float x, float textY, LootrunLootPoolData.LootrunItem item,
            ...
            if (textY + itemSpacing >= contentStartY && textY <= contentStartY + contentHeight) {
                ...
                if (item.type.equals("shiny")) {
                    ui.drawText((WynnExtrasConfig.INSTANCE.removeChroma ? rarityColor : "") + displayName.replace("⬡ ", ""), x + 20, textY, WynnExtrasConfig.INSTANCE.removeChroma ? CustomColor.fromHexString("FFFFFF") : CommonColors.RAINBOW, 3f);
                } else {
