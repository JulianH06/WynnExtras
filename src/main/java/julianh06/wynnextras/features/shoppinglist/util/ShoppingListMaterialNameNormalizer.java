...
public final class ShoppingListMaterialNameNormalizer {
    ...
    private ShoppingListMaterialNameNormalizer() {}
    ...
    private static String cleanMaterialText(String text) {
        return ShoppingListTextCleaner.clean(text).replace('_', ' ').replace('-', ' ');
    }
