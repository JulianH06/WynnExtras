...
public class ShoppingCartData {
    ...
    public static ShoppingCartData fromCart(ShoppingCart cart) {
    ...
    public static class EntryData {
        ...
        ShoppingEntry toShoppingEntry() {
            if (id == null || id.isBlank()) {
                throw new IllegalArgumentException("Shopping list cart entry id is blank");
            }
            if (displayName == null || displayName.isBlank()) {
                throw new IllegalArgumentException("Shopping list cart entry display name is blank");
            }
        ...
        int requiredAmount() {
            if (requiredAmount <= 0) {
                throw new IllegalArgumentException("Shopping list cart entry required amount must be positive");
            }
