...
public class BadgeService {
    private static final String HEARTBEAT_URL = "https://wynnextras.com/wynnextras-users/heartbeat";
    private static final String ACTIVE_URL = "https://wynnextras.com/wynnextras-users/active";
