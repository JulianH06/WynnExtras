...
public class WaypointElement {
    ...
    public void draw(int x, int y, int width, int height, DrawContext context) {
        ...
        RenderUtils.drawTexturedRect(context, nameBackgroundTexture, CustomColor.NONE, x + 3 * 3f / scaleFactor, y + 2.5f * 3 / scaleFactor, (float) (90 * 3) / scaleFactor, (float) (13 * 3) / scaleFactor, 90 * 3 / scaleFactor, 13 * 3 / scaleFactor);
        ...
        RenderUtils.drawTexturedRect(context, nameBackgroundTexture, CustomColor.NONE, x + 93.5f * 3 / scaleFactor, y + 2.5f * 3 / scaleFactor, (float) (90 * 3) / scaleFactor, (float) (13 * 3) / scaleFactor, 90 * 3 / scaleFactor, 13 * 3 / scaleFactor);
        ...
        if(waypoint.getCategory() == null) {
            FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("Select a category")), x + 97f * 3 / scaleFactor, y + 6f * 3 / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.TOP, TextShadow.NORMAL, 2.75f / scaleFactor);
        } else {
            FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of(waypoint.getCategory().name)), x + 97f * 3 / scaleFactor, y + 6f * 3 / scaleFactor, waypoint.getCategory().color, HorizontalAlignment.LEFT, VerticalAlignment.TOP, TextShadow.NORMAL, 2.75f / scaleFactor);
        }

        RenderUtils.drawTexturedRect(context, coordsBackgroundTexture, CustomColor.NONE, x + 3 * 3f / scaleFactor, y + 18f * 3 / scaleFactor, (float) (65 * 3) / scaleFactor, (float) (13 * 3) / scaleFactor, 65 * 3 / scaleFactor, 13 * 3 / scaleFactor);
        ...
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("x:")), x + (float) (6 * 3) / scaleFactor, y + (float) (25 * 3) / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 3f / scaleFactor);
        //xInput.draw(context);


        RenderUtils.drawTexturedRect(context, coordsBackgroundTexture, CustomColor.NONE, x + 2 + (float) width / 3, y + 18f * 3 / scaleFactor, 65f * 3 / scaleFactor, (float) (13 * 3) / scaleFactor, 65 * 3 / scaleFactor, 13 * 3 / scaleFactor);
        ...
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("y:")), x + (float) width / 3 + (float) (4 * 3) / scaleFactor, y + (float) (24 * 3) / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 3f / scaleFactor);
        //yInput.draw(context);


        RenderUtils.drawTexturedRect(context, coordsBackgroundTexture, CustomColor.NONE, x + 1 + (float) 2 * width / 3, y + 18f * 3 / scaleFactor, 65f * 3 / scaleFactor, (float) (13 * 3) / scaleFactor, 65 * 3 / scaleFactor, 13 * 3 / scaleFactor);
        ...
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("z:")), x + (float) 2 * width / 3 + 3.5f * 3 / scaleFactor, y + (float) (24 * 3) / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 3f / scaleFactor);
        //zInput.draw(context);
        ...
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("Highlight")), x + (float) (20 * 3) / scaleFactor, y + 37f * 3 / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 2.5f / scaleFactor);
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("Block")), x + (float) (20 * 3) / scaleFactor, y + 45.5f * 3 / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 2.75f / scaleFactor);
        ...
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("Show")), x + (float) (20 * 3) / scaleFactor + (float) width / 4, y + 37f * 3 / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 2.75f / scaleFactor);
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("Name")), x + (float) (20 * 3) / scaleFactor + (float) width / 4, y + 45.5f * 3 / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 2.75f / scaleFactor);
        ...
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("Show")), x + (float) (20 * 3) / scaleFactor + (float) 2 * width / 4, y + 37f * 3 / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 2.75f / scaleFactor);
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("Distance")), x + (float) (20 * 3) / scaleFactor + (float) 2 * width / 4, y + 45.5f * 3 / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 2.25f / scaleFactor);
        ...
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("See")), x + (float) (20 * 3) / scaleFactor + (float) 3 * width / 4, y + 37f * 3 / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 2.75f / scaleFactor);
        FontRenderer.getInstance().renderText(context, StyledText.fromComponent(Text.of("Through")), x + (float) (20 * 3) / scaleFactor + (float) 3 * width / 4, y + 45.5f * 3 / scaleFactor, CustomColor.fromHexString("ffffff"), HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE, TextShadow.NORMAL, 2.25f / scaleFactor);
    }
