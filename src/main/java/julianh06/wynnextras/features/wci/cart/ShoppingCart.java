package julianh06.wynnextras.features.wci.cart;
...
public class ShoppingCart {
    ...
    public void add(ShoppingEntry entry, int amount) { if (amount <= 0) throw new IllegalArgumentException("amount must be positive"); entries.merge(entry, amount, Integer::sum); }
