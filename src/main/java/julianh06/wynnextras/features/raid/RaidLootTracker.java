...
public class RaidLootTracker {
    ...
    public static void register() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (!loggedThisChest && Time.now().timestamp() > lastParse) { // TODO: DONT FORGETT TO READD + 60_000) {
                parseChest();
    ...
    private static void parseChest() {
        ...
        if(data.sessionData != null) data.sessionDataButItsAlwaysOneRunOffSoICanSubtractItFromTheNewSessionDataToGetTheLootFromJustTheLatestRaid = RaidLootData.RaidSpecificLoot.copy(data.sessionData);
